...
function PrimeraPlantaRegistro({ onBack, userName, onLogout }) {
  ...
  useEffect(() => {
    ...
    const historicoMensual = JSON.parse(localStorage.getItem('vitalia.primeraplanta.registros.anuales') || '{}')
  ...
  const descargarPDFPorMesesSeleccionados = (mesesSeleccionados) => {
    const mesActual = obtenerMesActual()
    const historico = JSON.parse(localStorage.getItem('vitalia.primeraplanta.registros.anuales') || '{}')
