...
function CuartaPlantaRegistro({ onBack, userName, onLogout }) {
  ...
  useEffect(() => {
    ...
    const historicoMensual = JSON.parse(localStorage.getItem('vitalia.cuartaplanta.registros.anuales') || '{}')
  ...
  const descargarPDFPorMesesSeleccionados = (mesesSeleccionados) => {
    const mesActual = obtenerMesActual()
    const historico = JSON.parse(localStorage.getItem('vitalia.cuartaplanta.registros.anuales') || '{}')
