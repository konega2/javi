...
// Datos predefinidos de la Cuarta Planta según la tabla
const puntosAguaPredefinidos = [
  { id: 1, lugar: 'CUARTA PLANTA', zona: '401', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 2, lugar: 'CUARTA PLANTA', zona: '402', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 3, lugar: 'CUARTA PLANTA', zona: '101', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 4, lugar: 'CUARTA PLANTA', zona: '102', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 5, lugar: 'CUARTA PLANTA', zona: '103', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 6, lugar: 'CUARTA PLANTA', zona: '104', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 7, lugar: 'CUARTA PLANTA', zona: '105', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 8, lugar: 'CUARTA PLANTA', zona: '106', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 9, lugar: 'CUARTA PLANTA', zona: '107', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 10, lugar: 'CUARTA PLANTA', zona: '108', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 11, lugar: 'CUARTA PLANTA', zona: '109', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 12, lugar: 'CUARTA PLANTA', zona: '110', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 13, lugar: 'CUARTA PLANTA', zona: '111', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 14, lugar: 'CUARTA PLANTA', zona: '112', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 15, lugar: 'CUARTA PLANTA', zona: '113', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 16, lugar: 'CUARTA PLANTA', zona: '114', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 17, lugar: 'CUARTA PLANTA', zona: '115', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 18, lugar: 'CUARTA PLANTA', zona: '116', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 19, lugar: 'CUARTA PLANTA', zona: '117', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 20, lugar: 'CUARTA PLANTA', zona: '118', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 21, lugar: 'CUARTA PLANTA', zona: '119', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 22, lugar: 'CUARTA PLANTA', zona: '120', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 23, lugar: 'CUARTA PLANTA', zona: '121', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 24, lugar: 'CUARTA PLANTA', zona: '122', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 25, lugar: 'CUARTA PLANTA', zona: '123', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 26, lugar: 'CUARTA PLANTA', zona: '124', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 27, lugar: 'CUARTA PLANTA', zona: '125', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 28, lugar: 'CUARTA PLANTA', zona: '126', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 29, lugar: 'CUARTA PLANTA', zona: '127', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 30, lugar: 'CUARTA PLANTA', zona: '128', tipoTerminal: 'GRIFO LAVABO Y GRIFO DUCHA', numGrifo: 2 },
  { id: 31, lugar: 'CUARTA PLANTA', zona: 'ALMACÉN', tipoTerminal: 'VERTEDERO', numGrifo: 1 }
]

function CuartaPlantaRegistro({ onBack, userName, onLogout }) {
  ...
  useEffect(() => {
    rotarRegistrosPorMes('cuartaplanta')
    const savedRegistros = localStorage.getItem('vitalia.cuartaplanta.registros')
    const savedIncidencias = localStorage.getItem('vitalia.incidencias')
    const savedPuntosPersonalizados = localStorage.getItem('vitalia.cuartaplanta.puntos')
    const historicoMensual = JSON.parse(localStorage.getItem('vitalia.cuartaplanta.registros.mensuales') || '{}')
  ...
  const saveRegistro = (puntoId, datos) => {
    ...
    localStorage.setItem('vitalia.cuartaplanta.registros', JSON.stringify(nuevosRegistros))
  ...
  const actualizarTareaDiaria = (puntoId, fecha, completada) => {
    ...
    if (!tareasDiarias[fecha]['cuarta_planta']) {
      tareasDiarias[fecha]['cuarta_planta'] = {}
    }
    
    tareasDiarias[fecha]['cuarta_planta'][puntoId] = completada
  ...
  const seTareaHechaHoy = (puntoId) => {
    ...
    const tareasDiarias = JSON.parse(localStorage.getItem('vitalia.tareas.diarias') || '{}')
    return tareasDiarias[hoy]?.cuarta_planta?.[puntoId] || false
  }
  ...
  const contarTareasHoy = () => {
    const hoy = new Date().toISOString().split('T')[0]
    const tareasDiarias = JSON.parse(localStorage.getItem('vitalia.tareas.diarias') || '{}')
    const tareasHoy = tareasDiarias[hoy]?.cuarta_planta || {}
  ...
  const agregarNuevaTarea = (nuevaTarea) => {
    ...
    localStorage.setItem('vitalia.cuartaplanta.puntos', JSON.stringify(puntosPersonalizados))
  ...
  const reiniciarCardsSeleccionadas = (tareasIds) => {
    ...
    setRegistros(nuevosRegistros)
    localStorage.setItem('vitalia.cuartaplanta.registros', JSON.stringify(nuevosRegistros))
    reiniciarTareasPlanta('cuarta_planta', tareasIds)
    setShowReiniciarModal(false)
  }

  const descargarPDFPorMesesSeleccionados = (mesesSeleccionados) => {
    const mesActual = obtenerMesActual()
    const historico = JSON.parse(localStorage.getItem('vitalia.cuartaplanta.registros.mensuales') || '{}')
    const actuales = JSON.parse(localStorage.getItem('vitalia.cuartaplanta.registros') || '{}')
  ...
  if (view === 'incidencias') {
    return (
      <IncidenciasLista 
        incidencias={incidencias.filter(inc => inc.zona.includes('CUARTA PLANTA') || inc.zona === 'General' || puntosAgua.some(p => p.zona === inc.zona))}
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center gap-4 mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-800">Cuarta Planta - Registro de Puntos de Agua</h2>
...
export default CuartaPlantaRegistro